...
One can program in many different styles: *object-oriented*, *procedural*, *imperative* and *generic*. It allows the developer to utilise many key features of object-oriented design, such as inheritance, encapsulation, polymorphism and . It also allows for more high-level, dynamic memory allocation and control compared to C.
